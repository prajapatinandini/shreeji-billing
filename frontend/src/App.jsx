            ...
            {appState === 'invoice' ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea value={invoice.address} onChange={e => setInvoice({...invoice, address: e.target.value})} placeholder="Client's address..." className="w-full p-2 border rounded h-16 outline-none focus:border-orange-500" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 mb-1">GSTIN:</label>
                  <input type="text" value={invoice.gstNo} onChange={e => setInvoice({...invoice, gstNo: e.target.value})} placeholder="Client's GST Number..." className="w-full p-2 border rounded uppercase outline-none focus:border-orange-500" />
                </div>
              </div>
            ) : (
              <div className="space-y-4">
